    ...
    <div id="about" className="py-5 abt-me">
      ...
      <div className="col-md-* ">
        <div className="p-abt text-center">
          ...
          <p className="m-3 ">
            Hi there! I'm Valentine-Marie Umeh, a passionate web developer with
            a flair for crafting clean, user-friendly interfaces. I thrive on
            turning ideas into beautiful, functional websites and applications.
            My goal is to not just write code, but to create seamless digital
